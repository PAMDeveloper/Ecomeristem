...
public:
    ...
    Predim(int index) : _index(index)
    {
        internal(PREDIM, &Predim::_predim);
        internal(LL_BL, &Predim::_LL_BL);

        external(PREDIM_PREVIOUS_LEAF, &Predim::_leaf_predim);
   }
    ...
    void compute(double t, bool /* update */)
    {
        ...
        _predim = std::max(1e-4, _slope_length_IN * (1. - 1. / _LL_BL) *
