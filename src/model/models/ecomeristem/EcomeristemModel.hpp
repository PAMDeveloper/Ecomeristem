...
class EcomeristemModel : public AbstractCoupledModel < EcomeristemModel >
{
public:
    ...
    EcomeristemModel(const ecomeristem::AbstractModel* parent);
    virtual ~EcomeristemModel();
