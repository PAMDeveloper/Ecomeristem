...
static void run(const std::string& simulation, int /* verbose */)
{
    ...
    //           << std::endl;
    // utils::DateTime::format_date("05-07-2014", date);
    // std::cout << utils::Trace::trace().elements().filter_time(
    //     utils::DateTime::toJulianDayNumber(date)).to_string()
    //           << std::endl;
    // utils::DateTime::format_date("06-07-2014", date);
    // std::cout << utils::Trace::trace().elements().filter_time(
    //     utils::DateTime::toJulianDayNumber(date)).to_string()
    //           << std::endl;
    // utils::DateTime::format_date("07-07-2014", date);
    // std::cout << utils::Trace::trace().elements().filter_time(
    //     utils::DateTime::toJulianDayNumber(date)).to_string()
    //           << std::endl;
    // utils::DateTime::format_date("08-07-2014", date);
    // std::cout << utils::Trace::trace().elements().filter_time(
    //     utils::DateTime::toJulianDayNumber(date)).to_string()
    //           << std::endl;
}
...
static int show_infos()
{
    std::cout << boost::format(
        "Ecomeristem - %1%\n"
        "Copyright (C) 2005 - 2015 The Ecomeristem Development Team.\n"
